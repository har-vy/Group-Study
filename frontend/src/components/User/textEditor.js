...
import { blogSave } from '../../services/blogSaveRender'
...
const Button = props => {
  const { contentState, title } = props
  ...
  return (
    <div className="button">
      <button onClick={() => onClick({ content: state, username: username, title: title })}>Submit</button>
    </div>
  )
}
